...
|Включено|После скачивания последних манифестов надстройки, отправляемой при отправке, из Exchange надстройки запускаются в сообщениях или собраниях. В противном случае отправка блокируется.|
