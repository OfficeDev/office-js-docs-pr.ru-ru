...
|Включен|После загрузки последних манифестов надстройки по отправке из Exchange надстройки запускаются при отправке элементов сообщений или собраний. В противном случае отправка блокируется.|
