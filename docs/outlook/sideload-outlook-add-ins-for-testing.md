...
1. Если манифест не содержит ошибок и путь действителен, надстройка теперь будет загружена и доступна как на рабочем столе, так и Outlook в Интернете. Он также будет установлен на всех поддерживаемых устройствах.
...
### <a name="classic-outlook-on-the-web"></a>Классические Outlook в Интернете
...
1. Нажмите кнопку **Получить надстройки** на ленте.
    ...
    >   OR
    >
    > - **Меню** файла, а затем выберите кнопку **Управление** надстройками на вкладке **Info,** чтобы открыть диалоговое окно надстройки в Outlook в Интернете. <br>Дополнительные статьи о веб-опыте в предыдущем разделе Sideload надстройки в Outlook [в Интернете.](#outlook-on-the-web)
...
1. Выполните действия в sideload надстройки в Outlook [веб-разделе](#outlook-on-the-web) в соответствии с вашей Outlook в Интернете.
