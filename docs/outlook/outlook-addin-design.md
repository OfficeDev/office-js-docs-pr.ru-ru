...
ms.locfileid: "65244830"
---
# <a name="outlook-add-in-design-guidelines"></a>Рекомендации по разработке надстроек Outlook

Надстройки — отличный способ дополнения базового набора функций Outlook. С помощью надстроек пользователи могут получать доступ к интерфейсам, задачам и содержимому от внешних разработчиков, не покидая папку "Входящие". После установки надстройки Outlook становятся доступны на всех платформах и устройствах.  
