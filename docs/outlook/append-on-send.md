...
> [!IMPORTANT]
> Эта функция в настоящее время поддерживается для [предварительной версии](../reference/objectmodel/preview-requirement-set/outlook-requirement-set-preview.md) в Outlook в Интернете и Windows с подпиской на Office 365. Узнайте [, как выполнить предварительный просмотр функции присоединения при отправке](#how-to-preview-the-append-on-send-feature) в этой статье для получения дополнительных сведений.
>
