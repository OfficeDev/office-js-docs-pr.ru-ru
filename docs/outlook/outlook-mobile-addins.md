...
> [!NOTE]
> Надстройки не работают в современных Outlook веб-браузере на Android. Сведения о поддерживаемых устройствах см. в Office [надстройки](../concepts/requirements-for-running-office-add-ins.md#client-requirements-non-windows-smartphone-and-tablet).
