...
> [!NOTE]
> <sup>Для запуска 1</sup> надстроек на основе событий в Outlook на Windows требуется как минимум Windows 10 версии 1903 (сборка 18362) или Windows Server 2019 версии 1903.
...
- Дополнительные Outlook в новом пользовательском интерфейсе Mac:
...
1. В Outlook пользовательском интерфейсе Mac создайте новое сообщение.
...
1. В Outlook на Windows создайте новое сообщение.
    ...
    ![Окно сообщения в Outlook на Windows с темой, задаемой при составлении.](../images/outlook-win-autolaunch.png)
...
- В разделе `Office.context.auth`:
  ...
  - `getAccessTokenAsync`
    > [!NOTE]
    > [OfficeRuntime.auth](/javascript/api/office-runtime/officeruntime.auth) поддерживается во всех версиях Outlook, поддерживающих активацию на основе событий и единый вход (SSO), в то время как [Office.auth](/javascript/api/office/office.auth) поддерживается только в определенных Outlook сборках. Дополнительные сведения см. в разделе "Включение единого входа" Outlook надстройки, использующие активацию [на основе событий](use-sso-in-event-based-activation.md).
