...
Необходимо помнить о некоторых аспектах и ограничениях при использовании известных сущностей в надстройке. При активации надстройки пользователь читает элемент, содержащий совпадения известных сущностями, независимо от того, используется ли `ItemHasKnownEntity` правило:
