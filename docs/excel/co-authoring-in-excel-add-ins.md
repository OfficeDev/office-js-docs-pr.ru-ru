...
Если вы хотите, чтобы пользовательские визуализации пользователя А соответствовали изменениям, внесенным соавторами в скрытом листе, используйте событие [BindingDataChanged](../../reference/shared/binding.bindingdatachangedevent.md). Это обеспечит отражение изменений, внесенных соавторами в содержимое книги, в вашей надстройке.
