...
1. Правила [проверки](https://support.microsoft.com/office/29fecbcc-d1b9-42c1-9d76-eff3ce5f7249) данных не должны применяться к ячейкам под таблицей, если проверка данных не применяется во всем столбце.
