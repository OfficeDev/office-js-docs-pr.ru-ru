...
Известные проблемы отслеживаются и сообщаются в репозитории Excel [настраиваемых GitHub.](https://github.com/OfficeDev/Excel-Custom-Functions/issues)
