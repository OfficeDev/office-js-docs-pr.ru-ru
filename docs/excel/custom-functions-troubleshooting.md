...
## <a name="common-problems-and-solutions"></a>Общие проблемы и решения

### <a name="cant-open-add-in-from-localhost-use-a-local-loopback-exemption"></a>Не может открыть надстройку из localhost: используйте локальное освобождение от циклов.

Если вы видите ошибку "Мы не можем открыть эту надстройку из localhost", необходимо включить локальное освобождение от циклов. Подробные сведения о том, как это сделать, см. в [этой статье службы поддержки Майкрософт](/office/troubleshoot/office-suite-issues/cannot-open-add-in-from-localhost).
