...
Дополнительные сведения о диалоговых окнах и API диалоговых окон см. в статье [Использование API диалоговых окон в надстройках Office](../develop/dialog-api-in-office-add-ins.md).
