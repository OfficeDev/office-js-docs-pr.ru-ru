...
6. Чтобы начать отладку, выберите **F5** **(или > запустить** отладку из меню). Новая книга Excel откроется с помощью вашей надстройки, уже загруженной и готовой к использованию.
...
На этом этапе выполнение остановится на строке кода, где установлена точка разрыва. Теперь вы можете ступить через код, установить часы и использовать все необходимые VS Code отладки.
...
4. Выберите **просмотр > выполнить** или ввести **Ctrl+Shift+D,** чтобы перейти на отлагивание представления.
5. Из параметров отлагивание выберите **Office Online (Edge Chromium).**
6. Откройте Excel в Microsoft Edge браузере и создайте новую книгу.
...
3. Если вы хотите запустить надстройку в настольной версии Excel, запустите следующую команду
    ...
    Или если вы хотите запустить надстройку в Excel в Интернете выполнить следующую команду
