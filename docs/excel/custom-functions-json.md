...
---
# <a name="create-json-metadata-for-custom-functions"></a>Создание метаданных JSON для пользовательских функций
...
Тем не менее, вы можете сделать проект пользовательских функций с нуля, но необходимо выполнить следующие действия:
