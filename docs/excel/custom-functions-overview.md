...
2. Создайте настраиваемую функцию надстройки Excel с помощью [Yo Office](https://github.com/OfficeDev/generator-office)и следуйте инструкциям в [проекте README.md](https://github.com/OfficeDev/Excel-Custom-Functions/blob/master/README.md) для запуска надстройки в Excel, внесите изменения в код и выполните отладку.
...
- **./config/customfunctions.json**содержит совмещение JSON, который сообщает Excel о пользовательской функции. Совмещение отображает вашу пользовательскую функцию в списке доступных функций, отображаемых при выполнении ввода в ячейку пользователем.
- **./index.html**, который предоставляет ссылку &lt;Script&gt; JS-файла. Этот файл не отображает пользовательский Интерфейс в Excel.
