...
2. В Excel выберите вкладку **Вставка**, а затем нажмите стрелку вниз, которая находится справа от пункта **Мои надстройки**. ![Снимок экрана: лента "Вставка" Excel для Windows с выделенной стрелкой вниз "Мои надстройки".](../images/select-insert.png)
