...
7. Замените `TODO1` приведенным ниже кодом. Примечание:
...
6. Замените `TODO1` приведенным ниже кодом. Примечание:
...
2. Выполните команду `npm run build` для преобразования исходного кода ES6 в JavaScript более ранней версии, которую поддерживает Internet Explorer (используется Excel в фоновом режиме для запуска надстроек Excel).

3. Выполните команду `npm start` для запуска веб-сервера, работающего на localhost.
