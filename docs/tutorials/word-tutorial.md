...
4. В Word создайте [пользовательский стиль](https://support.office.com/article/customize-or-create-new-styles-d38d6e47-f6fc-48eb-a607-1eb120dec563) с именем "MyCustomStyle". Его форматирование может быть любым.
...
3. В панели задач нажмите кнопку **Вставить абзац**, чтобы убедиться в том, что в верхней части документа есть абзац с "Microsoft 365".
