...
Найдите в манифесте строку `</DesktopFormFactor>`. Непосредственно перед ней вставьте приведенную ниже разметку XML. Обратите внимание на указанные ниже особенности этой разметки.
...
1. Следуйте инструкциям в статье [Загрузка неопубликованных надстроек Outlook для тестирования](../outlook/sideload-outlook-add-ins-for-testing.md), чтобы найти раздел **Пользовательские надстройки** в нижней части диалогового окна **Мои надстройки**.

1. Нажмите кнопку **...** рядом с пунктом **Git the gist**, а затем выберите **Удалить**.
