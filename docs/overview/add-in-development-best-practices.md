...
- Предлагайте [бесплатные пробные версии](https://msdn.microsoft.com/ru-ru/library/dn456317.aspx#Anchor_1). Если для вашей надстройки требуется подписка, сделайте некоторые функции доступными без нее.
