...
Чтобы узнать больше о том, как приступить к созданию надстройки Office, пройдите наши [5-минутные руководства по началу работы](https://docs.microsoft.com/ru-ru/office/dev/add-ins/). Вы можете сразу приступить к созданию надстроек с помощью Visual Studio или любого другого редактора. 
