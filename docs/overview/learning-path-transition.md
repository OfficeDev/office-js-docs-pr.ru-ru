...
По этим причинам большая часть этой статьи дублирует нашу схему обучения для начинающих пользователей расширений Office: [Начните отсюда! Руководство для начинающих, создающих надстройки Office](learning-path-beginner.md). Мы добавили некоторые учебные ресурсы, чтобы разработчики надстроек VSTO могли воспользоваться своим опытом и повторно использовать свой существующий код. 
