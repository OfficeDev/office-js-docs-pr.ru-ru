...
- Все URL-адреса, например расположения исходных файлов, указанные в элементе [SourceLocation](http://dev.office.com/reference/add-ins/manifest/sourcelocation), должны быть защищены **SSL-шифрованием (HTTPS)**.
...
- Надстройки, отправляемые в Магазин Office, также должны включать элемент [SupportUrl](http://dev.office.com/reference/add-ins/manifest/supporturl). Дополнительные сведения см. в разделе [Каких распространенных ошибок отправки следует избегать?](http://msdn.microsoft.com/library/0ceb385c-a608-40cc-8314-78e39d6c75d0%28Office.15%29.aspx#bk_q2)

- Чтобы указать домены, отличные от указанного в элементе [SourceLocation](http://dev.office.com/reference/add-ins/manifest/sourcelocation) для сценариев проверки подлинности, используйте только элемент [AppDomains](http://dev.office.com/reference/add-ins/manifest/appdomains).
...
[Схема манифеста контентной надстройки](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas/content)
...
[Схема манифеста контентной надстройки](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas/mail)
...
Сведения об устранении проблем, связанных с манифестом надстройки, см. в статье [Проверка манифеста и устранение связанных с ним неполадок](../../docs/testing/troubleshoot-manifest.md). Там указано, как проверить манифест согласно [XSD](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas), а также как отладить манифест с помощью ведения журнала в среде выполнения.

## <a name="additional-resources"></a>Дополнительные ресурсы


- [Определение команд надстройки в манифесте](../../docs/develop/define-add-in-commands.md)
- [Указание ведущих приложений Office и требований к API](../../docs/overview/specify-office-hosts-and-api-requirements.md)
- [Локализация надстроек для Office](../../docs/develop/localization.md)
- [Справочная схема по манифестам надстроек для Office](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas)
- [Проверка манифеста и устранение связанных с ним неполадок](../../docs/testing/troubleshoot-manifest.md)
