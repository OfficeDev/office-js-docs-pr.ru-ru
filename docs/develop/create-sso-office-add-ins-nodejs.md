...
11. После назначения для метода `Office.initialize` добавьте приведенный ниже код. Об этом коде нужно знать следующее.
...
2. Замените `TODO3` приведенным ниже кодом. Об этом коде нужно знать следующее.
...
1.  Замените `TODO2` приведенным ниже кодом. Об этом коде нужно знать следующее.
