...
* Office 2016 версии 1708 (сборка 8424.nnnn) или более поздней (версия подписки на Office 365, иногда называемая "нажми и работай").
  ...
  Для получения этой версии может понадобиться быть участником программы предварительной оценки Office. Дополнительные сведения см. в статье [Примите участие в программе предварительной оценки Office](https://products.office.com/ru-ru/office-insider?tab=tab-1).
...
1. Замените `TODO11` приведенным ниже кодом *непосредственно под последней закрывающей фигурной скобкой кода, который вы добавили на предыдущем шаге*. Вот что нужно знать об этом коде:
