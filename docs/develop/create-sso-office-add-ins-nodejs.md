...
## <a name="configure-the-add-in"></a>Конфигурация надстройкиAPPROVED
...
1. Замените заполнитель {application_GUID here} *в обоих местах* кода идентификатором приложения, скопированным во время регистрации надстройки. (Символы "{}" не являются частью идентификатора, поэтому не нужно их включать.) Это тот же идентификатор, который вы использовали для ClientID и Audience в файле web.config.
