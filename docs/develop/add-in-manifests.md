...
---
# <a name="office-add-ins-xml-manifest"></a>XML-???????? ????????? Office
...
| [?????????? (ContentApp)][]<br/>[?????????? (TaskPaneApp)][]<br/>[?????????? (MailApp)][] |    X    |     X     |    X    |
| [??????? (RuleCollection)][]<br/>[??????? (MailApp)][]                                             |         |           |    X    |
| [?????????? (MailApp)*][]                                                                  |         |           |    X    |
| [?????????*][]<br/>[????????? (MailAppRequirements)*][]                                                 |         |           |    X    |
| [?????*][]<br/>[Formsettings*][]                                                              |         |           |    X    |
| [????????? (??????????)*][]                                                                     |    X    |     X     |         |
| [?????*][]                                                                                   |    X    |     X     |         |
...
??? URI ???????????, ? ????????? ???????????? ??? [?????? ??????????][], ?????? ???????????? ???????????. ?????? ? ???????????? ?? ?????? ?????????? ????????? `Cache-Control`, ?????????? `no-cache`, `no-store` ??? ???????? ????????? ? HTTP-???????.
...
????? ??????? ??????, ???????? ?? ?????????? ? ???????? [SourceLocation](https://dev.office.com/reference/add-ins/manifest/sourcelocation) ??? ????????? ???????? ???????????, ??????????? ?????? ??????? [AppDomains](https://dev.office.com/reference/add-ins/manifest/appdomains).

## <a name="specify-domains-you-want-to-open-in-the-add-in-window"></a>???????? ???????, ??????? ?????????? ??????? ? ???? ??????????

?? ?????????, ???? ?????????? ???????? ??????? ?? URL-????? ? ??????, ???????? ?? ??????, ??? ????????? ????????? ???????? (?????? ? ???????? [SourceLocation](https://dev.office.com/reference/add-ins/manifest/sourcelocation) ????? ?????????), ???? URL-????? ????????? ? ????? ???? ????????, ? ?? ? ??????? ????????? ???????? ?????????? Office. ??? ????????? ?? ????????? ???????? ???????????? ?? ?????????????? ????????? ?? ????????? ? ??????? ????????? ??-?? ?????????? ????????? **iframe**.

????? ?????????????? ??? ?????????, ???????? ?????? ?????, ??????? ????????? ??????? ? ???? ??????????, ? ?????? ??????? ? ???????? [AppDomains](https://dev.office.com/reference/add-ins/manifest/appdomains) ????? ?????????. ???? ?????????? ?????????? ??????? ?? URL-?????? ??????, ?? ????????? ? ??????, ?? ???????? ????????? ? ????? ???? ???????? (?? ? ??????? ?????????).

? ??????????? ???? ??????? XML-????????? ??????? ???????? ?????????? ????????? ? ?????? `https://www.contoso.com`, ??? ??????? ? ???????? **SourceLocation**. ? ??? ????? ?????? ????? `https://www.northwindtraders.com` ? ???????? [AppDomain](http://msdn.microsoft.com/en-us/library/2a0353ec-5e09-6fbf-1636-4bb5dcebb9bf%28Office.15%29.aspx) ?? ?????? **AppDomains**. ???????? ?? ?????? www.northwindtraders.com ????? ??????????? ? ??????? ??????????.
...
## <a name="manifest-v11-xml-file-examples-and-schemas"></a>XML-????? ????????? ?????? 1.1: ??????? ? ?????
???? ???????? ??????? XML-?????? ????????? ?????? 1.1 ??? ????????? ??????? ?????, ?????????? ????????? ? ????????? Outlook.
...
???????? ?? ?????????? ???????, ????????? ? ?????????? ??????????, ??. ? ?????? [???????? ????????? ? ?????????? ????????? ? ??? ?????????](../testing/troubleshoot-manifest.md). ??? ???????, ??? ????????? ???????? ???????? [XSD](https://github.com/OfficeDev/office-js-docs-pr/tree/master/docs/overview/schemas), ? ????? ??? ???????? ???????? ? ??????? ??????? ??????? ? ????? ??????????.
