...
|
  [DefaultSettings (ContentApp)](http://msdn.microsoft.com/ru-ru/library/f7edc689-551f-1a17-ea81-ffd58f534557%28Office.15%29.aspx)<br/>
  [DefaultSettings (TaskPaneApp)](http://msdn.microsoft.com/ru-ru/library/36e3d139-56a4-fb3d-0a21-cbd14e606765%28Office.15%29.aspx)|X|X||
|
  [SourceLocation (ContentApp)](http://msdn.microsoft.com/ru-ru/library/00d95bb0-e8f5-647f-790a-0aa3aabc8141%28Office.15%29.aspx)<br/>
  [SourceLocation (TaskPaneApp)](http://msdn.microsoft.com/ru-ru/library/e6ea8cd4-7c8b-1da7-d8f8-8d3c80a088bc%28Office.15%29.aspx)|X|X||
|
...
|
  [Permissions (ContentApp)](http://msdn.microsoft.com/ru-ru/library/9f3dcf9c-fced-c115-4f0d-38d60fb7c583%28Office.15%29.aspx)<br/>
  [Permissions (TaskPaneApp)](http://msdn.microsoft.com/ru-ru/library/d4cfe645-353d-8240-8495-f76fb36602fe%28Office.15%29.aspx)<br/>
  [Permissions (MailApp)](http://msdn.microsoft.com/ru-ru/library/c20cdf29-74b0-564c-e178-b75d148b36d1%28Office.15%29.aspx)|X|X|X|
|
  [Rule (RuleCollection)](http://msdn.microsoft.com/ru-ru/library/c6ce9d52-4b53-c6a6-de7e-c64106135c81%28Office.15%29.aspx)<br/>
  [Rule (MailApp)](http://msdn.microsoft.com/ru-ru/library/56dfc32e-2b8c-1724-05be-5595baf38aa3%28Office.15%29.aspx)|||X|
|
  [*Requirements (MailApp)](http://msdn.microsoft.com/ru-ru/library/9536ea30-34f7-76b5-7f30-1508626840e4%28Office.15%29.aspx)|||X|
|
  [*Set](http://msdn.microsoft.com/ru-ru/library/1506daa1-332c-30e1-6402-3371bcd0b895%28Office.15%29.aspx)<br/>
  [**Sets (MailAppRequirements)](http://msdn.microsoft.com/ru-ru/library/2a6a2484-eeee-37e4-43bc-c185e8ae0d1d%28Office.15%29.aspx)|||X|
|
  [*Form](http://msdn.microsoft.com/ru-ru/library/77a8ac83-c22b-1225-4fc4-ba4038b68648%28Office.15%29.aspx)<br/>
  [**FormSettings](http://msdn.microsoft.com/ru-ru/library/0d1a311d-939d-78c1-e968-89ddf7ebc4b4%28Office.15%29.aspx)|||X|
|
...
Все URL-адреса, например расположения исходных файлов, указанные в элементе [SourceLocation](https://dev.office.com/reference/add-ins/manifest/sourcelocation), должны быть защищены **SSL-шифрованием (HTTPS)**.
...
## <a name="manifest-v11-xml-file-examples-and-schemas"></a>Примеры и схемы XML-файлов манифеста версии 1.1
...
### <a name="office-add-in-manifest-v11-example-with-commands-and-fallback-task-pane"></a>Пример манифеста версии 1.1 для надстройки Office с командами и резервной областью задач
[Схема манифеста для надстройки области задач](https://github.com/OfficeDev/office-js-docs-pr/tree/master/docs/overview/schemas/taskpane)
...
### <a name="content-add-in-manifest-v11-example"></a>Пример манифеста надстройки версии 1.1
[Схема манифеста контентной надстройки](https://github.com/OfficeDev/office-js-docs-pr/tree/master/docs/overview/schemas/content)
...
### <a name="outlook-add-in-manifest-v11-example"></a>Пример манифеста надстройки Outlook версии 1.1
[Схема манифеста контентной надстройки](https://github.com/OfficeDev/office-js-docs-pr/tree/master/docs/overview/schemas/mail)
...
- [Указание требований касательно API и ведущих приложений Office](specify-office-hosts-and-api-requirements.md)
