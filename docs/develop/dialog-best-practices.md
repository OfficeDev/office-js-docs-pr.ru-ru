...
В этой статье приводятся правила, руководства и рекомендации для API диалогов Office, включая рекомендации по проектированию пользовательского интерфейса диалогового окна и использованию API в одностраничных приложениях (SPA).
...
> 
> См. [также об обработке ошибок и событий в диалоговом окне Office](dialog-handle-errors-events.md).
...
- На хост-странице одновременно может быть открыто только одно диалоговое окно. Эта страница может быть либо областью задач, либо файлом [функции](/javascript/api/manifest/functionfile) [команды функции](../design/add-in-commands.md#types-of-add-in-commands).
...
Рекомендации по проектированию диалоговых окон см. в разделе ["Диалоговые окна" надстроек Office](../develop/dialog-api-in-office-add-ins.md).
...
### <a name="best-practices-for-using-the-office-dialog-api-in-an-spa"></a>Рекомендации по использованию API диалогов Office в spa
