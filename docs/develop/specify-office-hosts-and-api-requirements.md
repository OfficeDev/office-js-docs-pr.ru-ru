...
- Функции расширяемости, доступные только при запуске надстройки и реализуемые с Office.js API JavaScript; Например, [диалоговые окна](../design/dialog-boxes.md).
