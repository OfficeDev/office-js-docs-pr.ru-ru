...
После создания привязки с помощью одного из трех методов "добавить" объекта можно работать с данными и свойствами привязки с помощью методов соответствующего `Bindings` объекта: [MatrixBinding,](/javascript/api/office/office.matrixbinding) [TableBinding](/javascript/api/office/office.tablebinding)или [TextBinding](/javascript/api/office/office.textbinding). Все три этих объекта наследуют [методы getDataAsync](/javascript/api/office/office.binding#getdataasync-options--callback-) и [setDataAsync](/javascript/api/office/office.binding#setdataasync-data--options--callback-) объекта, которые позволяют взаимодействовать с `Binding` связанными данными.
