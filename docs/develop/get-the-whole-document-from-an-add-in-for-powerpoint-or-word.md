...
Вы можете также создать надстройку для PowerPoint или Word с помощью [Visual Studio](../get-started/create-and-debug-office-add-ins-in-visual-studio.md) или [любого редактора](../get-started/create-an-office-add-in-using-any-editor.md). 


### <a name="core-concepts-to-know-for-creating-a-task-pane-add-in"></a>Основные понятия, касающиеся создания надстроек области задач
