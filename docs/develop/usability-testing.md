...
Вы можете запускать тесты на доступность по-разному. Для многих разработчиков надстройки исследования удаленного и неизмеримого использования являются наиболее эффективными по времени и затратам. Это легко сделать несколькими популярными службами тестирования. Ниже приводится несколько примеров.
...
## <a name="1-sign-up-for-a-testing-service"></a>1. Подпишитесь на службу тестирования
...
Ниже приводится несколько примеров исследовательских вопросов.
...
Очень важно собрать данные обо всем процессе работы пользователя — от обнаружения надстройки до ее установки и использования. Рассмотрите вопросы исследований, которые рассматривают следующие аспекты пользовательского интерфейса надстройки.
