...
|EXCatalog (развертывание через Exchange Server) |GUID надстройки в ее манифесте.|EXCatalog. Строка EXCatalog — это строка, которую можно использовать с надстройки, которые используют централизованное развертывание Microsoft 365 центре администрирования.|Версия в манифесте надстройки.
