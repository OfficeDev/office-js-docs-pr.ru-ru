...
Вы можете проверить предыдущий пример с помощью Microsoft 365 подписки, чтобы опробовать централизованное развертывание и убедиться, что надстройка работает так, как ожидалось. Если у вас еще нет Microsoft 365 подписки, вы можете получить бесплатную, 90-дневную возобновляемую Microsoft 365 подписку, присоединившись к программе Microsoft 365 [разработчика](https://developer.microsoft.com/office/dev-program).
