...
6. Outlook вызывает обработчик события [initialize](http://dev.office.com/reference/add-ins/shared/office.initialize) объекта [Office](http://dev.office.com/reference/add-ins/shared/office) надстройки.
