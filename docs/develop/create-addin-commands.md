...
- Выполнять действия при выборе команды надстройки. Варианты действий:
  - Показать пользователю одну или несколько надстроек области задач. В надстройке области задач можно отобразить HTML, использующий пользовательский интерфейс Fluent для создания пользовательского интерфейса.
