...
Поставщики онлайновых услуг могут предоставлять общедоступные интерфейсы API с помощью REST. Разработчики могут использовать эти общедоступные интерфейсы API в своих надстроек Office для чтения или записи данных для поставщика онлайновых услуг. Интегрируя данные из онлайновых служб в надстройку, вы повышаете ее ценность и привлекаете больше пользователей. При использовании этих API в надстройке требуется проверка подлинности с помощью платформы авторизации OAuth.
