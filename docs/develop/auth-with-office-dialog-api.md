...
Так как диалоговое окно Office и область задач выполняются в разных экземплярах среды выполнения браузера [, необходимо](../testing/runtimes.md#browser-runtime) использовать библиотеки проверки подлинности и авторизации иначе, чем при проверке подлинности и авторизации в одном окне. В следующих разделах описывается, как можно и нельзя использовать эти библиотеки.
