...
?????? ? API ?????????? Office ???????????? ??????????? ????????????????? JavaScript ? ??? ???? ?????????????? ????????????????, ??????? ???? ?????? ???????? ??????????????? ?????????? ???????, ?????????? ???? ??????????? ???????? ????? ????????????? ?? ?????????? ????? ????????. ????????? ???????????? ???????? ? ???-????????? Office (? ????? ? ? ???????????????????? ?????????) ????? ???? ????????????? ??? ?????????? ??????????, ??????????? ??????? ? API JavaScript ??? Office ?????????????? ??? ???????????? ??????????. ??? ???? ????????, ??? ?????????? Office ????? ???????? ? ???????? ? ??????? ???????????????????. ??? ?????? ? ???????????? ???????? ???????? ????????? ????????? ??????? ????????? ??????.

????? ???? ??????????? ??????? ? API, ???????? [Document.getSelectedDataAsync](https://dev.office.com/reference/add-ins/shared/document.getselecteddataasync), [Binding.getDataAsync](https://dev.office.com/reference/add-ins/shared/binding.getdataasync) ??? [Item.loadCustomPropertiesAsync](https://dev.office.com/reference/add-ins/outlook/Office.context.mailbox.item), ????????????? ?? "Async". ??? ?????? ???????????? ?????? ?? ??????????? ?????????? ? ??? ?????????????? ??????? ????? ?????????? ??????. ?????????????? ??????? ????????? ??????, ???????????? ? ??????????? ?????, ??????????? ?????, ????? ?????? ?????? ??? ????????????? ????????. ?????? ??? ?????????? ??????, ?? ?????? ???????? ??????? ? ????????? ?????????.

?? ????????? ????? ??????? ????? ?????????? ??? ?????? ???????????? ??????, ??????? ????????? ??????, ?????????? ????????????? ? ?????????, ???????? ? ????????? ???-?????????? Word Online ??? Excel Online. ?? ?????? ?????? ???????????? ?????? ????? ?????????? JavaScript ???????? ??? ?????????? ????? ?????????????? ????????? ?? ??????? ???????, ???? ??? ? ?? ???????? ?? ?????. ????? ??????????? ????? ????????????, ???????? ????? ???????????? ?????????? ? ??????, ? ?????????? ????? ???????? ?????? ? ??????, ????????? ???????? ??? ???? ? ?????????? ?????????. ????? ?? ?????? ???????????? ?????????? ???????????? ??? ?????? ? ???????? ???????????? ???????????????????? ??????? Office, ???????? ? Word 2013 ??? Excel 2013.

*???. 1. ??????? ?????????? ??? ??????????? ????????????????*

![??????? ?????????? ???????????? ????????????????](../images/office15-app-async-prog-fig01.png)

????????? ???? ??????????? ??????????? ??? ? ???????????????????, ??? ? ? ???-????????, ? ??? ????? ????????? ?????????????? "??????????? ????????? ? ?????? ?? ?????????? ??????????" ?????? ?????????? ?????????? Office. ????????, ?? ?????? ??????? ?????????? ?????????? ??? ?????????? ??????? ????? ?? ?????? ???? ????, ??????? ????? ???????? ? ? Excel 2013, ? ? Excel Online.

## <a name="writing-the-callback-function-for-an-async-method"></a>????????? ??????? ????????? ?????? ??? ???????????? ??????


??????? ????????? ??????, ???????????? ? ??????????? ????? ? ???????? ????????? _callback_, ?????? ????????? ???????????? ????????, ??????? ?????? ????? ?????????????? ?????? ?????????? ?????????? ??? ?????????????? ??????? ? ??????? [AsyncResult](https://dev.office.com/reference/add-ins/shared/asyncresult) ??? ?????????? ???? ???????. ????????:
...
- ?????? ???????? _callback_ ? ??? ????????? ???????, ???????????? ? ?????. ? ???????? ?????????? ??? ?????????? ???????? _result_ ??? ??????? ? ???????? **value** ??????? **AsyncResult**, ????? ?????????? ??????, ?????????? ????????????? ? ?????????.
...
????? ????, ?? ?????? ???????? ??????????? ??????? ? ???????? ?? ??? ????????? _callback_ ???????????? ??????. ????????, ?????????? ?????? ????? ???????? ???, ????? ?????????? ??????? ? ?????? `writeDataCallback` ? ???????? ????????? _callback_.
...
???????? ????, ??? ???????????? ? ???????? **AsyncResult.value** ???????????? ??????, ??. ? ??????? "???????? ????????? ??????" ?????????? ?????? ??? ????? ??????. ?????? ???? ????????, ??????? ??????????? ??????, ??. ? ??????? ? ????? ?????? ?? ??????? [AsyncResult](https://dev.office.com/reference/add-ins/shared/asyncresult).
...
????????????? ????????? ???????? ??????? ? ??? ?????? ????????????????, ???????? ??????????? ????????????? ?? ????? JavaScript, ?? ??? ? ??????? ?????????? ????????? ???????? ????? ???? ?????? ??? ?????? ? ?????????. ? ???????? ???????????? ????????? ???????? ??????? API JavaScript ??? Office ????? ???????????? ?????????? ??????? promise. ?????? ? ??????? ?????? API JavaScript ??? Office ?????? promise ???????? ?????? ? ????? ??? ???????? [? ??????????? ???????? Excel ? ?????????? Word](bind-to-regions-in-a-document-or-spreadsheet.md).
...
- ??????? ?????????? ????? [Bindings.getByIdAsync](https://dev.office.com/reference/add-ins/shared/bindings.getbyidasync) ??? ????????? ??????? ? ???????? ? ????????? ? ?????? "MyBinding". ?????? **AsyncResult**, ???????????? ? ???????? `result` ????? ????????? ??????, ???????????? ?????? ? ?????????? ??????? ???????? ?? ???????? **AsyncResult.value**.
    
- ????? ?????? ????????, ? ???????? ??????? ?????? ?? ??????? ????????? `result`, ???????????? ??? ?????? ?????? [Binding.getDataAsync](https://dev.office.com/reference/add-ins/shared/binding.getdataasync).
    
- ?, ???????, ???????? `result2` ????????? ??????, ???????????? ? ????? **Binding.getDataAsync**, ???????????? ??? ??????????? ?????? ? ????????.
...
???????? ??????????? _BindingObjectAsyncMethod_ ??????? ??????? ?????? ?? ??????? ???????? **Binding**, ?????????????? ???????? promise: **getDataAsync**, **setDataAsync**, **addHandlerAsync** ??? **removeHandlerAsync**. ?????? ???? ??????? ?? ???????????? ?????????????? ??????? promise. ?? ????? ???????? ? ??????? [??????? ??????? ?????????? ????????? ??????](#AsyncProgramming_NestedCallbacks).

????? ?????????? promise ??????? **Binding** ??? ????? ???????? ???????????? ? ?????? ???????????? ??????, ??? ???? ?? ?? ??? ????????? (????? ?????????? ?????????? ?? ????? ???????? ???????? ?????????? ????????? promise). ???? promise ??????? **Binding** ?????????? ?????????, ????? ?????????? ?????????? ????? ?????????? ???????? ?????? ? ??????? ???????? ? ????????? ???, ????? ????? ?????? ???? ?? ?? ??????????? ???????.

? ????????? ??????? ???? ???????????? ????? **select**, ????? ???????? ???????? ? **id** "`cities`" ?? ????????? **Bindings**, ? ????? ??????? ????? [addHandlerAsync](https://dev.office.com/reference/add-ins/shared/asyncresult.value) ??? ?????????? ??????????? ??????? ??? ??????? [dataChanged](https://dev.office.com/reference/add-ins/shared/binding.bindingdatachangedevent) ????????.
...
? ????????? ??????? ????????, ??? ???????? ????? **Document.setSelectedDataAsync** ????? ???????? ?????????????? ?????????? ? ??????? `options`.
...
? ????? ???????? ? ??????????????? ??????????? _callback_ ??????????? ??? ????????? ???????? (??????? ?? ??????????????? ??????????? ??????????? ??? ?? ???????? ????????? _options_). ????? ????, ???????? _callback_ ????? ??????? ???? ?? ?????????? ??????? JSON, ???? ? ??????? `options`. ?????? ???????? _callback_ ????? ???????? ?????? ????? ?? ????????: ??? ? ??????? _options_ (?????????? ??? ????????? ??????), ??? ? ???????? ?????????? ?????????.
