...
1. В Excel, PowerPoint или Word, выберите вкладку **Вставка**, а затем нажмите стрелку вниз, находящуюся справа от панели **Мои надстройки**.
    ...
    ![Снимок экрана, показывающий Excel ленту Windows на Windows с выделенной стрелкой Мои надстройки](../images/excel-cf-register-add-in-1b.png)
