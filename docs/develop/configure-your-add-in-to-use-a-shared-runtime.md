...
Если вы начинаете новый проект, выполните указанные ниже действия, чтобы с помощью [генератора Yeoman для настроек Office](yeoman-generator-overview.md) создать проект надстройки Excel или PowerPoint.
