...
|Сделайте надстройку некоммерческой.|У надстройки не должно быть пробных версий, она не должна содержать платных возможностей, рекламы платных версий или ссылок на интернет-магазины, в которых пользователи могут приобрести другой контент, приложения или надстройки. На страницах с политикой конфиденциальности и условиями использования также не должно быть рекламы и ссылок на AppSource.|[Политика сертификации 1100,3](/legal/marketplace/certification-policies#11003-selling-additional-features)|
...
-  **Создайте надстройку с помощью Visual Studio.**
    ...
    Если вы разрабатываете надстройку с помощью Visual Studio, вы можете [задать точки останова и отладить их код](../develop/debug-office-add-ins-in-visual-studio.md) в клиентском приложении Office, работающем под управлением Windows, до неопубликованной надстройки на iPad или Mac. Так как надстройка, работающая в Office на iOS или Mac, поддерживает те же API, что и надстройка в Office в Windows, код надстройки должен выполняться одинаково на обеих платформах.
