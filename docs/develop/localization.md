...
Кроме того, необходимо создать проект надстройки Office в Visual Studio 2015.

> [!NOTE]
> Скачать Visual Studio 2015 можно на [странице со сведениями об Office Developer Tools](https://www.visualstudio.com/features/office-tools-vs), включающей ссылку на Office Developer Tools.
...
Запустите надстройку. Надстройка области задач загружается в Word 2013, а строки в ее пользовательском интерфейсе меняются в соответствии с языком ведущего приложения, как показано на рисунке ниже.
