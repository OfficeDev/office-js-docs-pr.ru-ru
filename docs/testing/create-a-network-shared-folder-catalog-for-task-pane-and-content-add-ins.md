...
Эта статья применяется только к тестированию надстройок Word, Excel, PowerPoint, Project и только Windows. Для выполнения тестирования на другой платформе или тестирования надстроек Outlook см. одну из указанных ниже тем о загрузке неопубликованных надстроек.
...
8. Выберите **кнопку ОК,** чтобы закрыть диалоговое окно **Options.**
