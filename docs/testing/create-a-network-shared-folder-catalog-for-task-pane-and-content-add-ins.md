...
---
# <a name="sideload-office-add-ins-for-testing-from-a-network-share"></a>Загрузка неопубликованных надстройки Office для тестирования из сетевой папки

Вы можете протестировать надстройку Office в клиенте Office, который находится в Windows, опубликовав манифест в сетевую общую папку (инструкции ниже). Этот вариант развертывания предназначен для использования после завершения разработки и тестирования на localhost, а также для тестирования надстройки с нелокального сервера или с помощью облачной учетной записи.
...
> - Если новая версия надстройки изменяет ленту, каждый пользователь должен будет переустановить надстройку.
...
Эта статья относится только к тестированию надстроек Word, Excel, PowerPoint и Project и только в Windows. Для выполнения тестирования на другой платформе или тестирования надстроек Outlook см. одну из указанных ниже тем о загрузке неопубликованных надстроек.
