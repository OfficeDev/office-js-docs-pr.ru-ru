...
Если у вас есть надстройка, которая отображает пользовательский интерфейс в панели задач или содержимом надстройки, вы можете отлаживать надстройку Office с помощью Safari Web Inspector. 
...
1.  Выполните вход на устройстве от имени администратора.
