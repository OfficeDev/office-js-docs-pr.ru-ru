...
|Ошибка: объект не поддерживает свойство или метод 'defineProperty'|Убедитесь, что Internet Explorer не работает в режиме совместимости. Перейдите в раздел Сервис > **Параметры просмотра в режиме совместимости**.|
...
- Откройте раздел Сервис > " **Свойства** > браузера **".**
