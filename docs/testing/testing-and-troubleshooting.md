...
- Перейдите в > **Internet** **OptionsAdvanced** > .
...
При открытии надстройки Office пользователю будет предложено разрешить отображение диалогового окна. Пользователь выбирает **Разрешить**, и возникает следующее сообщение об ошибке.
