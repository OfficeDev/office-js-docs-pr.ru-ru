...
description: Узнайте, как устранять ошибки пользователей в Office надстроек.
ms.date: 06/10/2022
...
1. Закройте Office.
1. Убедитесь, что манифест действителен. См[. раздел Office манифеста надстройки](troubleshoot-manifest.md).
...
- Перейдите к разделу "> **Internet Options** > **Advanced"**.
...
Чтобы устранить эту проблему, пользователи или администраторы могут добавить домен надстройки в список надежных сайтов в Microsoft Edge браузере.
