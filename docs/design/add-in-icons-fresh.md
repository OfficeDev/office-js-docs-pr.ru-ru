...
---
# <a name="fresh-style-icon-guidelines-for-office-add-ins"></a>Рекомендации по значкам свежего стиля для надстройок Office

Версии Office 2013+ (без подписки) Office используют иконографию Microsoft Fresh style. Если вы предпочитаете, чтобы значки совпадали со стилем Monoline Microsoft 365, см. рекомендации по значкам стилей Monoline для [надстройок Office.](add-in-icons-monoline.md)

## <a name="office-fresh-visual-style"></a>Визуальный стиль Office Fresh

Значки Fresh включают только необходимые коммуникативные элементы. Вспомогательные элементы, включая перспективу, градиенты и источник света, удалены. Упрощение значков способствует ускорению анализа команд и элементов управления. Следуйте этому стилю, чтобы наилучшим образом соответствовать клиентам Office без подписки.
...
|Используйте язык значков Office для представления поведения или концепций.|Не перенастройте глифы Office UI Fabric для команд надстроек в ленте приложений Office или контекстных меню. Значки Fabric отличаются по стилю, поэтому не будут совпадать.|
...
Значки Office обычно состоят из базового элемента с накладными действиями и концептуальными модификаторами. Модификаторы действия представляют такие понятия, как "добавить", "открыть", "создать" или "закрыть". Концептуальные модификаторы представляют состояние, изменение или описание значка.
