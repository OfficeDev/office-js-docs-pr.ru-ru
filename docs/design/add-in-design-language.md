...
[Fluent интерфейс является](../design/add-in-design.md) официальной интерфейсной структурой для создания с помощью языка Office дизайна. Использование Fluent пользовательского интерфейса является необязательным, но это самый быстрый способ обеспечить, чтобы ваши надстройки чувствовали себя естественным расширением Office. Создайте Fluent и создайте надстройки, которые дополняют Office.
