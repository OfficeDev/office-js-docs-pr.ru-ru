...
Для подписей осей лучше всего подходят светло-серые тона. Если вы используете Fabric, см. [нейтральную цветовую палитру](http://dev.office.com/fabric#/styles/colors).

### <a name="data-ink"></a>Информационные пиксели
