...
Рекомендуется использовать пользовательский [Fluent для](../design/add-in-design.md) создания хрома для визуализации данных. Fluent пользовательского интерфейса включает стили и компоненты, которые легко интегрируются с Office внешний вид.
...
- Включение [рампы Fluent](https://developer.microsoft.com/fluentui#/styles/web/typography) пользовательского интерфейса, чтобы сделать диаграммы совместимыми с пользовательским интерфейсом Office, который использует Segoe. Если же требуется отделить содержимое диаграммы от пользовательского интерфейса, вы можете использовать другой шрифт.
