...
Рекомендуется использовать пользовательский [интерфейс Fluent](../design/add-in-design.md) для создания хрома для визуализации данных. Fluent UI включает стили и компоненты, которые легко интегрируются с Office внешний вид.
...
- Включите рампу типа [Fluent,](https://developer.microsoft.com/fluentui#/styles/web/typography) чтобы сделать диаграммы совместимыми Office пользовательского интерфейса, который использует Segoe. Если же требуется отделить содержимое диаграммы от пользовательского интерфейса, вы можете использовать другой шрифт.
...
Для меток осей лучше всего подходят светло-серые тона. Если вы используете пользовательский интерфейс Fluent, см. палитру [нейтральных цветов.](https://developer.microsoft.com/fluentui#/styles/web/colors/neutrals)
...
Для линий сетки лучше всего подходят светло-серые тона. Если вы используете пользовательский интерфейс Fluent, см. палитру [нейтральных цветов.](https://developer.microsoft.com/fluentui#/styles/web/colors/neutrals)
