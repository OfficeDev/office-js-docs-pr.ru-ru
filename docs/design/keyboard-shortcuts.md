...
> [!NOTE]
> Клавиши KeyTips, также известные как последовательное клавиши, например ярлык Excel для выбора цвета заполнения **Alt+H, H**, не поддерживаются в Office надстроек.
...
- Если вам нужно больше клавиш, ознакомьтесь со списком Excel [клавиш и не](https://support.microsoft.com/office/1798d9d5-842a-42b8-9c99-9b7213f0040f) применяйте их в надстройки.
...
- См. [Excel надстройки](https://github.com/OfficeDev/Office-Add-in-samples/tree/main/Samples/excel-keyboard-shortcuts) к клавишам.
