...
* Ознакомьтесь с [рекомендациями в отношении значков](../design/add-in-icons.md), чтобы получить дополнительные сведения об оформлении значков команд надстроек с использованием цветовой палитры значков Office.