...
**С каким из перечисленных ниже репозиториев кода вы знакомы?**  
 a. SourceShelf [*Отклонение*]  
 b. CodeContainer [*Отклонение*]  
 c. GitHub [*Должен выбрать*]  
 d. BitBucket [*Может выбрать*]  
 e. CloudForge [*Может выбрать*]  
