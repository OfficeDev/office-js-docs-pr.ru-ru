...
> 
  **Примечание.** Рекомендуем тестировать удобство использования надстроек на нескольких платформах. Для [публикации надстройки в Магазине Office](https://msdn.microsoft.com/en-us/library/office/jj220037.aspx) она должна работать на всех [платформах, поддерживающих определенные вами методы](https://dev.office.com/add-in-availability).
