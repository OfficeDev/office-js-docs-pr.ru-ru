...
![GIF, отображающие открываемую панель с минимальными перемещающимися элементами рядом с GIF, которая показывает открытие панели со множеством движущихся элементов.](../images/add-in-motion-purpose.gif)

## <a name="use-expected-motions"></a>Используйте предсказуемые движения

Мы рекомендуем использовать пользовательский интерфейс [Fluent](https://developer.microsoft.com/fluentui#/) для создания визуального подключения к платформе Office, а также рекомендуем использовать Анимации пользовательского интерфейса [Fluent](https://developer.microsoft.com/fluentui#/styles/web/motion) для создания движений, которые соответствуют языку движения Fabric.
...
|Правильно|Неправильно|
|:-----|:-----|
|Используйте движение, которое соответствует поведению в пользовательском интерфейсе Fluent.| Не создавайте движения, которые конфликтуют со стандартными шаблонами движения в Office.
...
![GIF, который отображает открываемую модаль в ожидаемом порядке рядом с GIF, которая показывает непредвиденное открытие модального модуля.](../images/add-in-motion-expected.gif)
...
![GIF, отображающий загрузку плитки с помощью мягкого увядания рядом с GIF, отображающий загрузку плитки с отскоком](../images/add-in-motion-character.gif)

## <a name="see-also"></a>См. также

* [Рекомендации по анимации пользовательского интерфейса](https://developer.microsoft.com/fluentui#/styles/web/motion)
