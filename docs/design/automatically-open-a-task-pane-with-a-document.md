...
|**Продукты**|**Платформы**|
|:-----------|:------------|
|<ul><li>Word</li><li>Excel</li><li>PowerPoint</li></ul>|<ul><li>Office для Windows Desktop (сборки 16.0.8121.1000 или более поздней)</li><li>Office для Mac (сборки 15.34.17051500 или более поздней)</li><li>Office Online</li></ul>|
