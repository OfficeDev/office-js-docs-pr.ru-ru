...
|EXCatalog (развертывание через Exchange Server) |GUID надстройки в ее манифесте.|"EXCatalog". Строка EXCatalog - это строка, которая будет использоваться с надстройками, использующими централизованное развертывание в административном центре Office 365.|Версия в манифесте надстройки.
