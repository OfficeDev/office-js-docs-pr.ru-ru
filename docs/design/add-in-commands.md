...
- Outlook 2016 для Windows (сборка 16.0.4678.1000 или более поздняя)
- Office для Windows, подключенный к Office 365 (сборка 16.0.6769 или более поздняя)
- Office 2019 для Windows
- Office для Mac, подключенный к Office 365 (сборка 15.33 или более поздняя)
- Office 2019 для Mac
- Office Online
