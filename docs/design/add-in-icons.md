...
Значки - это визуальное представление поведения или концепции. Они часто используются для добавления значения в элементы управления и команды. Визуальные, реалистичные или символические, позволяют пользователю ориентироваться в пользовательском интерфейсе так же, как знаки помогают пользователям перемещаться по своей среде. Они должны быть простыми, понятными и содержать только необходимые данные, чтобы клиенты могли быстро анализировать, какие действия будут выполняться при выборе элемента управления.

Офисные ленточные интерфейсы имеют стандартный визуальный стиль. Это обеспечивает согласованность и знакомство с приложениями Office. Инструкции помогут вам разработать набор средств PNG для вашего решения, которое будет входить в естественную часть Office.
...
|:---|:---|
|Поддерживайте визуальные изображения простыми и понятными, сосредоточившись на ключевом элементе (-ях) связи.| Не используйте артефакты, делающие ваш значок грязным.|
...
|Повторно используйте общие визуальные метафоры Office, например кисть для форматирования или увеличительное стекло для поиска.|Не используйте повторно визуальные метафоры для разных команд. Использование одного и того же значка для разных поведений и концепций может вызвать путаницу. |
|Перерисуйте свои значки, чтобы сделать их маленькими или большими. Найдите время, чтобы перерисовать вырезы, углы и закругленные края, чтобы максимизировать четкость линии. |Не изменяйте размеры значков, уменьшая или увеличивая размер. Это может привести к плохому визуальному качеству и неясным действиям. Сложные значки, созданные в большем размере, могут потерять четкость при изменении размера. |
...
###<a name="base-element-padding"></a>Отступ между  элементами
