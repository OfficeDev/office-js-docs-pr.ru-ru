...
![Изображение, на котором показаны старые значки Office и обновленный дизайн в современной интерпретации](../../images/icons_image.PNG)

## <a name="icon-guidelines"></a>Рекомендации по созданию значков
При создании значков следуйте перечисленным ниже рекомендациям. 

- Чтобы достичь наилучших результатов, используйте сетку с шагом 1 пк и инструмент для редактирования растровых изображений.  
- Перерисовывайте значки, но не изменяйте их размеры. При увеличении или уменьшении размеров значков перерисуйте контуры, углы и скругленные края, чтобы максимизировать четкость линий. 
- Удалите артефакты, которые визуально искажают изображение значка.
- Не используйте повторно значки Office UI Fabric в ленте или контекстном меню Office. Значки Fabric отличаются по стилю, поэтому не будут совпадать. 
...
- Не используйте повторно визуальные метафоры для различных команд. Добавление одинаковых значков для различных действий может привести к путанице. 
...
![Рисунок, на котором показана рекомендация не сжимать значки, а изменить их размер](../../images/icon_resizing.png)
...
![Изображение, на котором базовый элемент значка показан в центре, модификатор действия — в левом верхнем углу, а другой модификатор — в нижнем правом углу](../../images/icon_layout.PNG)
...
|**Размер значка**|**Отступ вокруг базового элемента**|
|:---|:---|
|16 пк|0|
|20 пк|1 пк|
|24 пк|1 пк|
...
|**Размер значка**|**Размер модификатора**|
|:---|:---|
|16 пк|9 пк|
|20 пк|10 пк|
|24 пк|12 пк|
...
|:---|:---|:---|:---|:---|
|Серый цвет текста (80)|80, 80, 80|#505050|![Изображение серого цвета текста (80)](../../images/textGray_80.gif)|Текст|
|Серый цвет текста (95)|95, 95, 95|#5F5F5F|![Изображение серого цвета текста (95)](../../images/textGray_95.gif)|Текст|
|Серый цвет текста (105)|105, 105, 105|#696969|![Изображение серого цвета текста (105)](../../images/textGray_105.gif)|Текст|
|Темно-серый (32)|128, 128, 128|#808080|![Изображение темно-серого цвета (32)](../../images/darkGray_32.gif)|32 и больше|
|умеренно серый (32)|158, 158, 158|#9E9E9E|![Изображение умеренно серого цвета (32)](../../images/mediumGray_32.gif)|32 и больше|
|Светло-серый (ВСЕ)|179, 179, 179|#B3B3B3|![Изображение светло-серого цвета (для всех размеров)](../../images/lightGray_all.gif)|Все размеры|
|Темно-серый (16)|114, 114, 114|#727272|![Изображение темно-серого цвета (16)](../../images/darkGray_16.gif)|16 и меньше|
|Умеренно серый (16)|144, 144, 144|#909090|![Изображение умеренно серого цвета (16)](../../images/mediumGray_16.gif)|16 и меньше|
|Синий (32)|77, 130, 184|#4d82B8|![Изображение синего цвета (32)](../../images/blue_32.gif)|32 и больше|
|Синий (16)|74, 125, 177|#4A7DB1|![Изображение синего цвета (16)](../../images/blue_16.gif)|16 и меньше|
|Желтый (ВСЕ)|234, 194, 130|#EAC282|![Изображение желтого цвета для всех размеров](../../images/yellow_all.gif)|Все размеры|
|Оранжевый (32)|231, 142, 70|#E78E46|![Изображение оранжевого цвета (32)](../../images/orange_32.gif)|32 и больше|
|Оранжевый (16)|227, 142, 70|#E3751C|![Изображение оранжевого цвета (16)](../../images/orange_16.gif)|16 и меньше|
|Розовый (ВСЕ)|230, 132, 151|#E68497|![Изображение розового цвета для всех размеров](../../images/pink_all.gif)|Все размеры|
|Зеленый (32)|118, 167, 151|#76A797|![Изображение зеленого цвета (32)](../../images/green_32.gif)|32 и больше|
|Зеленый (16)|104, 164, 144|#68A490|![Изображение зеленого цвета (16)](../../images/green_16.gif)|16 и меньше|
|Красный (32)|216, 99, 68|#D86344|![Изображение красного цвета (32)](../../images/red_32.gif)|32 и больше|
|Красный (16)|214, 85, 50|#D65532|![Изображение красного цвета (16)](../../images/red_16.gif)|16 и меньше|
|Сиреневый (32)|152, 104, 185|#9868B9|![Изображение сиреневого цвета (32)](../../images/purple_32.gif)|32 и больше|
|Сиреневый (16)|137, 89, 171|#8959AB|![Изображение сиреневого цвета (16)](../../images/purple_16.gif)|16 и меньше|
...
- [Рекомендации по разработке надстроек](../overview/add-in-development-best-practices.md)
