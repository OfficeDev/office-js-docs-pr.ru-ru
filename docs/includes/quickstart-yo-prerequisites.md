- <span data-ttu-id="494af-101">[Node.js](https://nodejs.org) (версия 8.0.0 или более поздняя)</span><span class="sxs-lookup"><span data-stu-id="494af-101">[Node.js](https://nodejs.org) (version 8.0.0 or later)</span></span>
