- <span data-ttu-id="fc575-101">[Node.js](https://nodejs.org) (версия 8.0.0 или более поздняя)</span><span class="sxs-lookup"><span data-stu-id="fc575-101">[Node.js](https://nodejs.org) (version 8.0.0 or later)</span></span>
