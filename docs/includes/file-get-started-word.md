...
_????????? ?: Word 2016, Word ??? iPad, Word ??? Mac_

? ???? ?????? ?? ????????, ??? ??????? ?????????? Word, ????????? jQuery ? API JavaScript ??? Word. 
...
2. ? ?????? ????? ??????? ?????????? ???? **Visual C#** ??? **Visual Basic**, ?????????? **Office/SharePoint**, ? ????? ???????? **??????????** > **???-?????????? Word**. 
...
4. ??????? `DefaultValue` ???????? `Description` ???????? ???????????. ???????? ??? ??????? **?????????? ??????? ????? ??? Word**.
...
1. ????????????? ????? ?????????? Word ? Visual Studio, ????? ??????? F5 ??? ?????? **?????????**, ????? ????????? Word ? ??????? ?????????? **Show Taskpane** (???????? ??????? ?????) ?? ?????. ?????????? ????? ????????? ?? ????????? ??????? IIS.
...
3. ??????? `DefaultValue` ???????? `Description` ???????? ???????????. ???????? ??? ??????? **?????????? ??????? ????? ??? Word**.
