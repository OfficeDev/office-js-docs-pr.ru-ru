<h2>Ресурсы</h2>
<p>Используйте следующие ресурсы, чтобы задавать вопросы, сообщать о проблемах или предлагать функции, связанные с платформой надстроек Office или API JavaScript. Сведения о дополнительных ресурсах см. в статье <a href="../resources/resources-links-help.md">Надстройки Office: дополнительные ресурсы</a></p>
