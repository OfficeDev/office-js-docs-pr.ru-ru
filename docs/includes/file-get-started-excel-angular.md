# <a name="build-an-excel-add-in-using-angular"></a>???????? ?????????? Excel ? ??????? Angular

? ???? ?????? ??????????? ??????? ???????? ?????????? Excel ? ??????? Angular ? API JavaScript ??? Excel.

## <a name="prerequisites"></a>??????????? ??????????

- ??????????, ??? [?????????? ??? ????????????? CLI ??? Angular](https://github.com/angular/angular-cli#prerequisites), ? ?????????? ??? ??????????? ??????????.
...
2. ? ???-???????? ????????? ?? ?????? `https://localhost:3000`. ???? ???????? ????????? ? ???, ??? ?????????? ????? ?? ???????? ??????????, ???????, ??? ??? ????? ????????. ?????????????? ???????? ??. ? ?????? [?????????? ??????????????? ??????????? ??? ??????????? ????????? ???????????](https://github.com/OfficeDev/generator-office/blob/master/src/docs/ssl.md).

    > [!NOTE]
    > Chrome ????? ?????????? ?????????? ?????????????? ? ???, ??? ??????? ??????? ?? ???????? ??????????? ????? ???? ????? [??? ?????????? ? ?????? ?????????? ???????? ????????????](https://github.com/OfficeDev/generator-office/blob/master/src/docs/ssl.md). ?? ?????? ???????????? ??? ??????????????. ????? ?????????, ??? ?????????? ???????? ??????????, ????????? ?? ?????? `https://localhost:3000` ? Internet Explorer ??? Microsoft Edge. 
