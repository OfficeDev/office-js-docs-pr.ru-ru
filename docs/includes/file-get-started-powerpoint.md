...
? ???? ?????? ??????????? ??????? ???????? ?????????? PowerPoint ? ??????? jQuery ? API JavaScript ??? Office.
...
2. ? ?????? ????? ??????? ?????????? ???? **Visual C#** ??? **Visual Basic**, ?????????? **Office/SharePoint**, ????? ???????? **??????????** > **???-?????????? PowerPoint**. 
...
4. ??????? `DefaultValue` ???????? `Description` ???????? ???????????. ???????? ??? ?? ?????? **?????????? ??????? ????? ??? PowerPoint**.
...
1. ????????????? ????? ?????????? PowerPoint ? ??????? Visual Studio, ????? ??????? F5 ??? ?????? **?????????**, ????? ????????? PowerPoint ? ??????? ?????????? **Show Taskpane** (???????? ??????? ?????) ?? ?????. ?????????? ????? ????????? ?? ????????? ??????? IIS.
...
3. ??????? `DefaultValue` ???????? `Description` ???????? ???????????. ???????? ??? ?? ?????? **?????????? ??????? ????? ??? PowerPoint**.
...
1. ?????? ????????? ??? ?????? ?????????, ????????? ???????????????? ?????????? ? PowerPoint.
    ...
    - Windows: [???????? ???????????????? ????????? Office ? Windows](../testing/create-a-network-shared-folder-catalog-for-task-pane-and-content-add-ins.md)
    - PowerPoint Online: [???????? ???????????????? ????????? Office ? Office Online](../testing/sideload-office-add-ins-for-testing.md#sideload-an-office-add-in-on-office-online)
    - iPad ? Mac: [???????? ???????????????? ????????? Office ?? iPad ? Mac](../testing/sideload-an-office-add-in-on-ipad-and-mac.md)
