...
2. Создайте файл в корне проекта (где находится index.html) под названием popup.html.
3. Добавьте в popup.html приведенный ниже код. Примечание:
...
5. Добавьте указанный ниже код в файл popup.js. Примечание:
...
5. Под строкой, назначающей обработчик щелчков для кнопки `freeze-header`, добавьте приведенный ниже код. Вы создадите метод `openDialog` на одном из следующих этапов.
...
8. Замените `TODO1` приведенным ниже кодом. Примечание:
   ...
   - Параметр первый — URL-адрес открываемой страницы.
...
1. Продолжайте работать в файле app.js. Замените `TODO2` приведенным ниже кодом. Примечание:
