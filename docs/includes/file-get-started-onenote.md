...
3. С помощью генератора Yeoman создайте проект надстройки OneNote. Выполните приведенную ниже команду и ответьте на вопросы, как показано ниже:
    ...
    - **Какое клиентское приложение Office вы хотели бы поддерживать?:** `Onenote`
...
3. В диалоговом окне "Отправить надстройку" выберите файл **one-note-add-in-manifest.xml** в папке проекта и затем нажмите **Отправить**. 
