...
? ???? ?????? ?? ????????, ??? ??????? ?????????? OneNote, ????????? jQuery ? API JavaScript ??? Office.
...
2. ???????? ??????? `<main>` ?????? ???????? `<body>` ??????????? ???? ????????? ? ????????? ????. ??? ???????? ????????? ????????? ??????? ? ??????, ????????? [?????????? Office UI Fabric](http://dev.office.com/fabric/components).
...
3. ??????? `DefaultValue` ???????? `Description` ???????? ???????????. ???????? ??? ??????? **?????????? ??????? ????? ??? OneNote**.
...
- ??? ??????? ?????????? ????? ???????????? ????????? ? ???????? ???????? ????????????. ??? ????????????? ???-??????? Gulp ? ??????? ? Internet Explorer ??? Chrome ?? ?????? ????????? ????????? ????????? ? ????????? ????????????, ? ????? ?????? ???????? iFrame ??????????.

- ???????????? ?????? OneNote, ?? ???????, ??? ????????? ??? ????????????? ???????? ????? ?????????????? ????????. ????????, ??????? ?????????? ?????????, ????? ???????? *undefined*. ?????????? ???? `_proto_`, ????? ??????? ????????, ??????? ?????????? ??? ???????, ?? ??? ?? ?????????.
...
> [????? API JavaScript ??? OneNote](../onenote/onenote-add-ins-programming-overview.md)
