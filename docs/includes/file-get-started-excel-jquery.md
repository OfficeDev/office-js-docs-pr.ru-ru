...
4. |||UNTRANSLATED_CONTENT_START|||In your code editor, open **index.html** in the root of the project.|||UNTRANSLATED_CONTENT_END||| Этот файл содержит HTML-контент, который будет отображаться в области задач надстройки. 
