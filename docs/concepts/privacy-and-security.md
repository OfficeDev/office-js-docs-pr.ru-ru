...
- [Управление конфиденциальностью для приложений Microsoft 365](/deployoffice/privacy/overview-privacy-controls)
