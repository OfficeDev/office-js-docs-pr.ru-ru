...
|19|Надстройка обнаружила ошибку времени выполнения|Критическая|В надстройке Office возникла проблема, которая привела к сбою. Для получения дополнительных сведений просмотрите журнал **оповещений Microsoft Office** с помощью средства просмотра событий Windows на компьютере, на котором произошла ошибка.|
|20|Сбой надстройки при проверке лицензирования|Критическая|Не удалось проверить сведения о лицензировании для надстройки Office; возможно, срок ее действия истек. Для получения дополнительных сведений просмотрите журнал **оповещений Microsoft Office** с помощью средства просмотра событий Windows на компьютере, на котором произошла ошибка.|
