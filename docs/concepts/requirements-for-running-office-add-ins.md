...
Для представления на высоком уровне о том, Office в настоящее время поддерживаются надстройки, см. Office клиентского приложения и доступности платформы для [Office надстройки](../overview/office-add-in-availability.md).
...
Для надстройок контента и области задач в поддерживаемых Office клиентских приложениях — Excel, PowerPoint, Project или Word — также требуется каталог приложений в SharePoint, чтобы загрузить XML-файл манифеста надстройки или развернуть надстройку с помощью [интегрированных приложений](/microsoft-365/admin/manage/test-and-deploy-microsoft-365-apps).[](../publish/publish-task-pane-and-content-add-ins-to-an-add-in-catalog.md)
...
Специально для Outlook на смартфонах и Windows планшетных устройствах необходимо следующее программное обеспечение для тестирования и запуска Outlook надстройки.

| Приложение Office | Устройство | Операционная система | Учетная запись Exchange | Мобильный браузер |
|:-----|:-----|:-----|:-----|:-----|
|Outlook для Android|Планшеты и смартфоны с Android|Android 4.4 KitKat или более поздней версии|О последнем обновлении Приложения Microsoft 365 для бизнеса или Exchange Online|Приложение native для Android; браузер, не применимый|
|Outlook для iOS|Планшеты iPad, смартфоны iPhone|iOS 11 или более поздняя версия|О последнем обновлении Приложения Microsoft 365 для бизнеса или Exchange Online|Родной приложение для iOS; браузер, не применимый|
...
> [!IMPORTANT]
> Следующие надстройки больше не требуются или доступны для Outlook надстройки.
>
> - Веб-браузеры на Android.
> - Родной OWA приложений для Android, OWA для iPad и OWA для iPhone - они были [обесценена](https://support.microsoft.com/office/076ec122-4576-4900-bc26-937f84d25a4b).
