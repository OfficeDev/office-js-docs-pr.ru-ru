...
1. Выберите **"Сведения"**.
1. В левом верхнем углу страницы  "Сведения" под именем файла в документе с поддержкой WIP будет отображаться значок в регистре, за которым следует элемент **Managed by Work (...)**.
