...
- Какого типа эти данные: документ, рабочая книга, презентация или проект?
...
- Будут ли клиенты использовать надстройку для улучшения содержимого документа? Если да, может быть целесообразно создать **контентную надстройку**.
