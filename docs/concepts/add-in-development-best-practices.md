...
description: Применяйте рекомендации при разработке для создания Office надстроек.
ms.date: 05/01/2022
...
- Создавайте надстройки, которые помогают пользователям выполнять свои задачи быстро и эффективно. Основное внимание следует уделить сценариям, применимым для приложений Office. Например:
  ...
  - Внедрение дополнительных служб в Office приложения.
...
- Убедитесь, что внешний вид и поведение вашей надстройки согласованы с интерфейсом Office. См[. раздел "Разработка пользовательского интерфейса Office надстроек"](../design/add-in-design.md).
...
- Используйте свойство [Context.touchEnabled](/javascript/api/office/office.context#office-office-context-touchenabled-member), чтобы определить, включено ли Office, в котором работает надстройка.
...
> [!NOTE]
> Если вы используете Fluent [пользовательского React](../design/using-office-ui-fabric-react.md) для элементов конструктора, многие из этих элементов встроены в систему проектирования.
...
- Сведите к минимуму обмен данными между надстройки и Office документом. Дополнительные сведения см. в [разделе "Избегайте использования метода context.sync в циклах"](correlated-objects-pattern.md).
