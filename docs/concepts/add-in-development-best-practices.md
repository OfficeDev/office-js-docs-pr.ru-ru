...
- Создавайте надстройки, которые помогают пользователям выполнять свои задачи быстро и эффективно. Основное внимание следует уделить сценариям, применимым для приложений Office. Например:
  ...
  - Внедрять дополняющие службы в приложениях Office.
...
- Разработайте обучающий интерфейс, чтобы помочь пользователям и персонализировать среду.
  ...
  ![Снимок экрана, иллюстрирующий сравнение "Do" и "не". В примере "Do" показана надстройка, включающая в себя кнопку, с помощью которой пользователи могут начать работу. В примере "не" показана надстройка без вводных шагов или кнопок.](../images/contoso-part-catalog-do-dont.png)
...
- Если ваша контентная надстройка привязывается к данным в документе, включите пример данных или шаблон, чтобы показать пользователям рекомендуемый формат данных.
  ...
  ![Снимок экрана, иллюстрирующий сравнение "Do" и "не". В примере "Do" показана надстройка, включающая в себя кнопку, с помощью которой пользователи могут вставлять образцы данных. В примере "не" показана надстройка без образцов данных или кнопок.](../images/add-in-title.png)
...
- Используйте свойство [context. touchEnabled](/javascript/api/office/office.context#touchenabled) , чтобы определить, включено ли сенсорный ввод для приложения Office, в котором работает надстройка.
