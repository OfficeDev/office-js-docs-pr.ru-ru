...
- Предлагайте [бесплатные пробные версии](https://docs.microsoft.com/ru-ru/office/dev/store/decide-on-a-pricing-model#office-store-pricing-options). Если для вашей надстройки требуется подписка, сделайте некоторые функции доступными без нее.
...
- Используйте [проверку подлинности с единым входом](https://docs.microsoft.com/ru-ru/outlook/add-ins/authenticate-a-user-with-an-identity-token).
...
- Используйте [понятный и простой язык](../design/add-in-design-guidelines.md#voice-guidelines) в надстройке.

- Учитывайте [специальные возможности](../design/ui-elements/accessibility-guidelines.md). Обеспечьте удобство работы для всех пользователей и поддержку таких специальных возможностей, как средство чтения с экрана.
...
- Используйте свойство [Context.touchEnabled](https://dev.office.com/reference/add-ins/shared/office.context.touchenabled), чтобы определить, поддерживается ли сенсорное управление ведущим приложением, в котором работает надстройка.
...
- Опубликуйте надстройку в [AppSource](https://docs.microsoft.com/ru-ru/office/dev/store/submit-to-the-office-store) и [рекламируйте ее](https://docs.microsoft.com/ru-ru/office/dev/store/promote-your-office-store-solution) на своем веб-сайте. Создайте [эффективное описание для AppSource](https://docs.microsoft.com/ru-ru/office/dev/store/create-effective-office-store-listings).
