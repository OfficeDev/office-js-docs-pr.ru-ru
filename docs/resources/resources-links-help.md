...
|**Запросы на добавление функций API JavaScript для Office**| Чтобы отправить запрос на функции для API JavaScript Office, отправьте свою идею в техническое сообщество [разработчиков Microsoft 365.](https://techcommunity.microsoft.com/t5/microsoft-365-developer-platform/idb-p/Microsoft365DeveloperPlatform)|
...
|**Script Lab**| Если вы хотите изучить API JavaScript Office или опробовать API предварительного просмотра, вы можете использовать Лабораторию скриптов в Excel, Outlook, PowerPoint и Word. Дополнительные сведения см. в статье [Изучение API JavaScript для Office с помощью Script Lab](../overview/explore-with-script-lab.md). |
|**Курс Pluralsight о надстройках Office**| Курс Джона Брауна "Основы создания надстроек Office с API <a href="https://www.pluralsight.com/courses/build-office-addins-js-api" target="_blank">JavaScript Office"</a> учит вас разработке надстройки PowerPoint с нуля, включая сведения о том, как взаимодействовать с Trello и публиковать надстройку в Магазине Office.|
