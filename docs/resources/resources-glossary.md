...
Среда **выполнения JavaScript —** это среда узла браузера, в котором выполняется надстройка. В Office для Windows и Office для Mac среда выполнения JavaScript — это встроенный элемент управления браузером (или веб-представление), например Internet Explorer, Устаревшая версия Edge, Edge WebView2 или Safari. Различные части надстройки выполняются в отдельных средах выполнения JavaScript. Например, команды надстроек, пользовательские функции и код области задач обычно используют отдельные среды выполнения JavaScript, если только вы не настроите общую среду выполнения JavaScript. [Дополнительные сведения см. в статье "Браузеры, используемые надстройки Office](../concepts/browsers-used-by-office-web-add-ins.md)".
...
Общая среда **выполнения JavaScript** или общая среда выполнения позволяет выполнять весь код в надстройке, включая область задач, команды надстроек и пользовательские функции, для выполнения в одной среде выполнения JavaScript и продолжать выполнение даже при закрытии области задач. [Дополнительные сведения см](../develop/configure-your-add-in-to-use-a-shared-runtime.md). в статье "Настройка надстройки Office для использования общей среды выполнения JavaScript и советы по использованию общей среды выполнения [JavaScript](https://devblogs.microsoft.com/microsoft365dev/tips-for-using-the-shared-javascript-runtime-in-your-office-add-in%e2%80%af/) в надстройке Office".
