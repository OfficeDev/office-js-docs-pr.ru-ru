...
5. Скопируйте корневой URL-адрес (например: ); он понадобится при редактировании файла манифеста надстройки в `https://YourDomain.azurewebsites.net` этой статье.
