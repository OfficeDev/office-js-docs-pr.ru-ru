...
Visual Studio создаст базовую надстройку Word, которую вы можете опубликовать в том виде, в котором она есть, не внося изменений в ее веб-проект. Чтобы создать надстройку для другого типа узла Office, например Excel, повторите эти действия и выберите тип проекта с желаемым узлом Office.
