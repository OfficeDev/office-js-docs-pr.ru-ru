...
3.  Подпишитесь на Azure.
    ...
    > [!NOTE]
    > Если у вас еще нет подписки на Azure, вы можете [получить ее в рамках своей подписки на Visual Studio](http://www.windowsazure.com/pricing/member-offers/msdn-benefits/) или [зарегистрировать бесплатную учетную запись](https://azure.microsoft.com/pricing/free-trial). 
...
3. В XML-файле манифеста найдите и замените все экземпляры ~remoteAppUrl URL-адресом корня веб-приложения надстройки в Azure. Это URL-адрес, который вы скопировали ранее после публикации веб-приложения надстройки в Azure (например, https://YourDomain.azurewebsites.net)). 
