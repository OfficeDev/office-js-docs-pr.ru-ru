...
Простейшая надстройка Office состоит из XML-файла манифеста и HTML-страницы. XML-файл манифеста описывает характеристики надстройки, такие как имя, рабочие клиенты Office, в которых он может работать, а также URL-адрес HTML-страницы надстройки. HTML-страница находится в веб-приложении, с которым пользователи взаимодействуют при установке и запуске надстройки в клиентском приложении Office. Вы можете разместить веб-приложение надстройки Office на любой платформе размещения веб-сайтов, в том числе Azure.
...
Visual Studio создаст базовую надстройку Word, которую вы можете опубликовать в том виде, в котором она есть, не внося изменений в ее веб-проект. Чтобы сделать надстройку для другого приложения Office, например Excel, повторите эти действия и выберите тип проекта с нужным приложением Office.
