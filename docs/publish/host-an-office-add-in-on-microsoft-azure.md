...
1. Установите [Visual Studio 2017](https://www.visualstudio.com/downloads) и не забудьте включить рабочую нагрузку **Разработка для Azure**.
    ...
    > [!NOTE]
    > Если Visual Studio 2017 уже установлен, убедитесь, что рабочая нагрузка **Разработка для Azure** установлена, [используя установщик Visual Studio](https://docs.microsoft.com/ru-ru/visualstudio/install/modify-visual-studio). 
...
## <a name="step-1-create-a-shared-folder-to-host-your-add-in-xml-manifest-file"></a>Шаг 1. Создайте общую папку для размещения XML-файла манифеста надстройки
...
## <a name="step-3-create-a-web-app-in-azure"></a>Шаг 3. Создайте веб-приложение в Azure
...
## <a name="step-7-insert-and-run-the-add-in-in-the-office-client-application"></a>Этап 7. Вставка и запуск надстройки в клиентском приложении Office
