...
|
  [AppSource](https://docs.microsoft.com/ru-ru/office/dev/store/submit-to-the-office-store)|Для распространения надстройки среди всех пользователей.|
...
- 
  [Создание эффективных описаний в AppSource](https://docs.microsoft.com/ru-ru/office/dev/store/create-effective-office-store-listings)
- [Устранение ошибок, с которыми сталкиваются пользователи при работе с надстройками Office](../testing/testing-and-troubleshooting.md)
  ...
  [AppSource]: https://docs.microsoft.com/ru-ru/office/dev/store/submit-to-the-office-store
