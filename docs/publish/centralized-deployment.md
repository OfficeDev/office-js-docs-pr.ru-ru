...
7. На странице **Централизованное развертывание** выберите один из следующих вариантов:
    ...
    ![Диалоговое окно "Создание Add-In" в центре администрирования Microsoft 365](../images/new-add-in.png)
...
- **Бизнес-надстройка**: если администратор явным образом отправил файл манифеста (с устройства или с помощью URL-адреса) при реализации централизованного развертывания с помощью центра администрирования Microsoft 365, администратор должен отправить новый файл манифеста, который содержит нужные изменения. После отправки обновленного файла манифеста надстройка обновится при следующем запуске соответствующего приложения Office.
