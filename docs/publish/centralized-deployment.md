...
9. Надстройка теперь доступна для назначения. На странице надстройки указано состояние **Включена**, как для надстройки Power BI Tiles на приведенном ниже снимке экрана. В разделе **У кого есть доступ** нажмите **Изменить**, чтобы назначить надстройку пользователям и/или группам.
...
[Определение пригодности централизованного развертывания надстроек для вашей организации Office 365](https://support.office.com/en-us/article/Determine-if-Centralized-Deployment-of-add-ins-works-for-your-Office-365-organization-b4527d49-4073-4b43-8274-31b7a3166f92)
