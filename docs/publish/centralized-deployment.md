...
Вы можете развертывать надстройки Office поэтапно, чтобы предотвратить возникновение проблем. Рекомендуем следующий план.
...
1. Разверните надстройку для большей группы пользователей в предприятии, которые будут работать с надстройкой. Если развертывание прошло успешно, переходите к этапу 3.

1. Разверните надстройку для всех пользователей, которые будут работать с надстройкой.
...
Если организация соответствует всем требованиям, выполните следующие действия для публикации надстройки Office с помощью централизированного развертывания.
...
1. Выберите один из следующих параметров на странице **Централизованное развертывание.**
...
1. Если добавляется надстройка из Магазина Office, выберите ее. Вы можете просматривать доступные надстройки по категориям **Рекомендуемое**, **Оценка** и **Имя**. Из Магазина Office можно добавлять только бесплатные надстройки. Добавление платных надстроек сейчас не поддерживается.
...
1. Выберите **Продолжить** после просмотра сведений о надстройки, политике конфиденциальности и условиях лицензии.

    ![Выбранная страница надстройки в Центр администрирования Microsoft 365.](../images/selected-add-in-admin-center.png)

1. На странице **Назначение пользователей** выберите **"Все",** **"Конкретные пользователи/группы"** или **"Только я".** С помощью поля поиска найдите пользователей и группы, для которых нужно развернуть надстройку. Для Outlook надстройки можно также выбрать метод развертывания **Fixed,** **Available** или **Optional.**
...
1. По завершению выберите **Развертывание**. Этот процесс может занять до трех минут. Затем нажмите кнопку **Далее**, чтобы завершить выполнение пошаговых инструкций. Теперь вы видите надстройки вместе с другими Office приложениями.
...
Администраторы могут назначить надстройку всем или только определенным пользователям и/или группам в организации. В следующем списке описываются последствия каждого варианта.
...
1. В окне надстройки перейдите на вкладку **Управляемые администратором**.
1. Выберите нужную надстройку и нажмите **Добавить**.
...
1. На вкладке надстройки выберите элемент **Управляемые администратором**.
1. Выберите нужную надстройку и нажмите **Добавить**.
