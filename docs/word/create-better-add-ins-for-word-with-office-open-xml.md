...
Скачайте пример кода Нагрузка и напишите [Open XML](https://github.com/OfficeDev/PnP-OfficeAddins/tree/main/Samples/word-add-in-load-and-write-open-xml)в надстройке Word, которая содержит разметку Office Open XML и код Office.js, необходимый для вставки любого из следующих примеров в Word.
...
> [!NOTE]
> Замените  _yourXMLfilename_ именем и пути XML-файла, как вы сохранили его в решении. Если вы не знаете, где включить [XML-файлы](https://github.com/OfficeDev/PnP-OfficeAddins/tree/main/Samples/word-add-in-load-and-write-open-xml) в решение или как ссылаться на них в коде, см. в примере кода надстройки Word и рабочего примера разметки и JavaScript, показанных здесь.
...
См. измененную разметку на примере диаграммы, показанной на рисунке 11 в "Нагрузка" и напишите [Open XML](https://github.com/OfficeDev/PnP-OfficeAddins/tree/main/Samples/word-add-in-load-and-write-open-xml) в примере кода надстройки Word.
