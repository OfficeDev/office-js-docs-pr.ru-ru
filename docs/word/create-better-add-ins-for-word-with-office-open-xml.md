...
# <a name="create-better-add-ins-for-word-with-office-open-xml"></a>Создание лучших надстроек Word с помощью Office Open XML
...
### <a name="javascript-for-using-setselecteddataasync"></a>JavaScript для использования метода setSelectedDataAsync
...
В этой функции все строки, кроме последней, используются для получения сохраненной разметки и ее использования в методе [setSelectedDataAsync](http://msdn.microsoft.com/ru-ru/library/fp142145.aspx) в конце функции. Для метода **setSelectedDataASync** требуется только указать содержимое, которое необходимо вставить, и тип приведения.
...
- Пытается привязаться к именованному элементу управления содержимым с помощью метода [addFromNamedItemAsync](http://msdn.microsoft.com/ru-ru/library/fp123590.aspx). 
...
- [API JavaScript для Office](http://msdn.microsoft.com/ru-ru/library/fp142185.aspx)
...
- [Общие сведения об интерфейсе JavaScript API для Office: привязка данных и пользовательские XML-части](http://msdn.microsoft.com/en-us/magazine/dn166930.aspx)
