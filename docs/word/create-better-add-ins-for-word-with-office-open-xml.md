...
Скачайте пример кода Нагрузка и напишите [Open XML](https://github.com/OfficeDev/Office-Add-in-samples/tree/main/Samples/word-add-in-load-and-write-open-xml)в надстройке Word, которая содержит разметку Office Open XML и код Office.js, необходимый для вставки любого из следующих примеров в Word.
...
> [!NOTE]
> Замените  _yourXMLfilename_ именем и пути XML-файла, как вы сохранили его в решении. Если вы не знаете, где включить [XML-файлы](https://github.com/OfficeDev/Office-Add-in-samples/tree/main/Samples/word-add-in-load-and-write-open-xml) в решение или как ссылаться на них в коде, см. в примере кода надстройки Word и рабочего примера разметки и JavaScript, показанных здесь.
...
Чтобы проверить разметку Office XML для примеров каждого из этих типов контента, показанных ранее в рисунках 5-8, ознакомьтесь с разделом Загрузка и записывание Open XML в примере кода надстройки [Word,](https://github.com/OfficeDev/Office-Add-in-samples/tree/main/Samples/word-add-in-load-and-write-open-xml) на который ссылается в разделе обзор.
