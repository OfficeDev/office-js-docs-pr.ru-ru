...
Элемент `Dictionary` и его дочерние элементы, относящиеся к созданию файла манифеста надстройки словаря, описаны в следующих разделах. Сведения о других элементах в файле манифеста см. в [XML-манифесте надстроек Office](../develop/add-in-manifests.md).
