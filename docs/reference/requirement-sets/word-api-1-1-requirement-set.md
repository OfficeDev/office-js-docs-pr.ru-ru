...
||[paragraphs](/javascript/api/word/word.contentcontrol#paragraphs)|Получает коллекцию объектов абзаца в области управления контентом.|
...
|[Document](/javascript/api/word/word.document)|[body](/javascript/api/word/word.document#body)|Получает объект тела основного документа.|
...
||[getSelection()](/javascript/api/word/word.document#getSelection__)|Возвращает текущий выбранный фрагмент документа.|
...
|[Section](/javascript/api/word/word.section)|[body](/javascript/api/word/word.section#body)|Получает объект тела раздела.|
||[getFooter (тип: Word.HeaderFooterType)](/javascript/api/word/word.section#getFooter_type_)|Возвращает один из нижних колонтитулов раздела.|
