...
| [События защиты таблиц](../../excel/excel-add-ins-worksheets.md#detect-changes-to-the-worksheet-protection-state) | Отслеживание изменений состояния защиты таблицы и источника этих изменений. | [WorksheetProtectionChangedEventArgs](/javascript/api/excel/excel.worksheetprotectionchangedeventargs), [Таблица](/javascript/api/excel/excel.worksheet), [WorksheetCollection](/javascript/api/excel/excel.worksheetcollection) |
