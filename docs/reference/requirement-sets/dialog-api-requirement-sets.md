...
Dialog API 1.1 — это первая версия этого API. Набор требований 1,2 добавляет поддержку отправки данных из родительской страницы в диалоговое окно с `Office.ui.messageChild` методом. Дополнительные сведения об этих API можно найти в справочном разделе по [API диалоговых окон](/javascript/api/office/office.ui) .
