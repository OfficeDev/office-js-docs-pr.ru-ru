...
|9041|Ошибка сети|Пользователь больше не подключен к сети. Проверьте сетевое подключение и повторите попытку.|У пользователя больше нет доступа к сети или Интернету.|
...
|13000–13010|||См. статью [Причины и обработка ошибок, связанных с методом getAccessTokenAsync](/office/dev/add-ins/develop/troubleshoot-sso-in-office-add-ins#causes-and-handling-of-errors-from-getaccesstokenasync).|
