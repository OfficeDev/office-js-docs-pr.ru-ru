...
|1008|Ошибка чтения данных|Размер запрошенного набора данных превышает допустимый.|Пользователь запрашивает чтение данных за пределами данных, определенными приложением Office.|
...
|2009|Ошибка записи данных|Размер указанного объекта данных превышает допустимый.|Пользователь пытается задать данные за пределами данных, определенными приложением Office.|
