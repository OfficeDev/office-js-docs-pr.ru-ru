...
> [!IMPORTANT] 
> Для элементов, содержащих атрибут идентификатора, необходимо предоставить уникальный идентификатор. Рекомендуем использовать название компании с идентификатором. Например, используйте следующий формат.
