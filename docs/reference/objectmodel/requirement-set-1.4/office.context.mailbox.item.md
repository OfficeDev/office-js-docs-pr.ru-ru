...
Получает объект, который предоставляет методы для получения или обновления в строке Bcc (скрытой копии) сообщения. Только в режиме создания.
...
####  <a name="cc-arrayemailaddressdetailsjavascriptapioutlook14officeemailaddressdetailsrecipientsjavascriptapioutlook14officerecipients"></a>cc :Array.<EmailAddressDetailsRecipients[ ](/javascript/api/outlook_1_4/office.emailaddressdetails)>|[ ](/javascript/api/outlook_1_4/office.recipients)
