...
#### <a name="attachments-arrayattachmentdetailsjavascriptapioutlook14officeattachmentdetails"></a>вложения: Array. <[AttachmentDetails](/javascript/api/outlook_1_4/office.attachmentdetails)>
...
#### <a name="bcc-recipientsjavascriptapioutlook14officerecipients"></a>СК: [получатели](/javascript/api/outlook_1_4/office.recipients)
...
*   [Получатели](/javascript/api/outlook_1_4/office.recipients)
...
#### <a name="body-bodyjavascriptapioutlook14officebody"></a>основной текст: [Body](/javascript/api/outlook_1_4/office.body)
...
#### <a name="cc-arrayemailaddressdetailsjavascriptapioutlook14officeemailaddressdetailsrecipientsjavascriptapioutlook14officerecipients"></a>CC: Array. <[EmailAddressDetails](/javascript/api/outlook_1_4/office.emailaddressdetails)>|[получатели](/javascript/api/outlook_1_4/office.recipients)
...
#### <a name="end-datetimejavascriptapioutlook14officetime"></a>конец: Дата | [Time (время](/javascript/api/outlook_1_4/office.time) )
...
В примере ниже показано, как с помощью метода [`setAsync`](/javascript/api/outlook_1_4/office.time#setasync-datetime--options--callback-) объекта `Time` задать время окончания встречи.
...
#### <a name="from-emailaddressdetailsjavascriptapioutlook14officeemailaddressdetails"></a>от: [EmailAddressDetails](/javascript/api/outlook_1_4/office.emailaddressdetails)
...
#### <a name="location-stringlocationjavascriptapioutlook14officelocation"></a>Местоположение: строка | [Location (расположение](/javascript/api/outlook_1_4/office.location) )
...
#### <a name="optionalattendees-arrayemailaddressdetailsjavascriptapioutlook14officeemailaddressdetailsrecipientsjavascriptapioutlook14officerecipients"></a>optionalAttendees: Array. <[EmailAddressDetails](/javascript/api/outlook_1_4/office.emailaddressdetails)>|[получатели](/javascript/api/outlook_1_4/office.recipients)
...
#### <a name="organizer-emailaddressdetailsjavascriptapioutlook14officeemailaddressdetails"></a>Организатор: [EmailAddressDetails](/javascript/api/outlook_1_4/office.emailaddressdetails)
...
#### <a name="requiredattendees-arrayemailaddressdetailsjavascriptapioutlook14officeemailaddressdetailsrecipientsjavascriptapioutlook14officerecipients"></a>requiredAttendees: Array. <[EmailAddressDetails](/javascript/api/outlook_1_4/office.emailaddressdetails)>|[получатели](/javascript/api/outlook_1_4/office.recipients)
...
#### <a name="sender-emailaddressdetailsjavascriptapioutlook14officeemailaddressdetails"></a>Отправитель: [EmailAddressDetails](/javascript/api/outlook_1_4/office.emailaddressdetails)
...
#### <a name="start-datetimejavascriptapioutlook14officetime"></a>Начало: Дата | [Time (время](/javascript/api/outlook_1_4/office.time) )
...
#### <a name="subject-stringsubjectjavascriptapioutlook14officesubject"></a>Тема: строка | [Subject (тема](/javascript/api/outlook_1_4/office.subject) )
...
#### <a name="to-arrayemailaddressdetailsjavascriptapioutlook14officeemailaddressdetailsrecipientsjavascriptapioutlook14officerecipients"></a>Кому: Array. <[EmailAddressDetails](/javascript/api/outlook_1_4/office.emailaddressdetails)>|[получатели](/javascript/api/outlook_1_4/office.recipients)
